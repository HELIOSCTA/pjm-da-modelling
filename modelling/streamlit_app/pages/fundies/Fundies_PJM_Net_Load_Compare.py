"""Fundies — PJM Net Load Compare: overlay two forecast dates from one vintage."""
...
st.title("Fundies — PJM Net Load Compare")
st.caption(
    "Overlay two forecast dates from the same PJM-native as-of vintage. "
    "Defaults to today vs tomorrow; pick any pair in the sidebar."
)
