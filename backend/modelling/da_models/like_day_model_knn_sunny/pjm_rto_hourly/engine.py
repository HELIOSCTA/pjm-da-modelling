"""Engine for pjm_rto_hourly (Sunny variant) — scalar per-HE matching.
...
from backend.modelling.da_models.like_day_model_knn_sunny import calendar as _calendar
from backend.modelling.da_models.like_day_model_knn_sunny import configs
from backend.modelling.da_models.like_day_model_knn_sunny.configs import ModelSpec
