...
from backend.modelling.da_models.like_day_model_knn_sunny.configs import KnnModelConfig, ModelSpec
...
def print_config(
    ...
    from backend.modelling.da_models.like_day_model_knn_sunny import (
        configs as _configs_module,
    )
    from backend.modelling.da_models.like_day_model_knn_sunny.domains import (
